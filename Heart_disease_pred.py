...
# loading the models
rfc_model = pickle.load(open('https://github.com/KothariRhythm/Heart_Disease_Prediction/tree/master/heart_disease_trained_model_rfc.sav','rb'))
dt_model = pickle.load(open('https://github.com/KothariRhythm/Heart_Disease_Prediction/tree/master/heart_disease_trained_model_dt.sav','rb'))
lr_model = pickle.load(open('https://github.com/KothariRhythm/Heart_Disease_Prediction/tree/master/heart_disease_trained_model_lr.sav','rb'))
standardize = pickle.load(open('https://github.com/KothariRhythm/Heart_Disease_Prediction/tree/master/StandardFunction.sav','rb'))

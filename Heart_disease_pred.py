...
# loading the models
rfc_model = pickle.load(open('D:/ml project/Heart Disease Prediction/heart_disease_trained_model_rfc.sav','rb'))
dt_model = pickle.load(open('D:/ml project/Heart Disease Prediction/heart_disease_trained_model_dt.sav','rb'))
lr_model = pickle.load(open('D:/ml project/Heart Disease Prediction/heart_disease_trained_model_lr.sav','rb'))
standardize = pickle.load(open('D:/ml project/Heart Disease Prediction/StandardFunction.sav','rb'))
